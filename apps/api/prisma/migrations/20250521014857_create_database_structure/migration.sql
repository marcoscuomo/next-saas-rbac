...
CREATE TABLE "members" (
    ...
    "organizartion_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "tokens_provider_user_id_key" ON "tokens"("provider", "user_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "members_organizartion_id_user_id_key" ON "members"("organizartion_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "members" ADD CONSTRAINT "members_organizartion_id_fkey" FOREIGN KEY ("organizartion_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
